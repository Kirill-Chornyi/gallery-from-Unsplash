...
export function SquareItem(props) {

  return (
    <div className='square-item'>
<div className="square-item__photo">
  <Photo src={props.src} localId={props.localId}/></div>
        <div className="square-item__title">Photo by {props.photoBy}</div>
